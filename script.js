document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("editFileBtn").addEventListener("click", async () => {
    ...
    // Fase 1: tarik isi file kalau belum dalam mode edit
    if(editingFile !== name) {
      try {
        ...
        editingFile = name;
        log(`✏️ File ${name} siap diedit. Lakukan perubahan di textarea dan tekan Edit File lagi.`, "info");
      } catch(e) {
